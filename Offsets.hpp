...
// Core
constexpr uint64_t OFF_LEVEL = 0x17e9d24;                         //[Miscellaneous]->LevelName
constexpr uint64_t OFF_LOCAL_PLAYER = 0x23e7ff8;                  //[Miscellaneous]->LocalPlayer
constexpr uint64_t OFF_ENTITY_LIST = 0x1f14e08;                   //[Miscellaneous]->cl_entitylist

constexpr uint64_t OFF_NAME_LIST = 0xd2e3460;                     //[Miscellaneous]->NameList
//constexpr uint64_t OFF_NAME_INDEX = 0x38;                         //nameIndex

// HUD
constexpr uint64_t OFF_VIEWRENDER = 0x7543e00;                    //[Miscellaneous]->ViewRender
...
constexpr uint64_t OFF_INATTACK = 0x07543f28;                     //[Buttons]->in_attack
